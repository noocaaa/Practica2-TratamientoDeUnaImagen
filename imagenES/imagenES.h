/**
  * @class ImagenES
  * @file imagenES.h
  * @brief Fichero cabecera para la E/S de im�genes. Permite la E/S de archivos de tipo PGM,PPM
  * @author Joaquin Valdivia
  */
...
/**
  ...
  * @param datos punteros a los @a f x @a c x 3 bytes que corresponden a los valores de los p�xeles de la imagen en formato RGB.
